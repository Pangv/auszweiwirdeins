  ...
  <div class="min-h-screen bg-primary p-6 md:p-12">
    <div class="max-w-7xl mx-auto">
      ...
      <div v-else class="space-y-16">
        ...
        <!-- Zusagen -->
        <section>
          <h2 class="text-4xl font-extrabold mb-8 text-secondary border-b-4 border-accent inline-block">
            Zusagen</h2>
        ...
        <!-- Absagen -->
        <section>
          <h2 class="text-4xl font-extrabold mb-8 text-secondary border-b-4 border-gray-400 inline-block">
            Absagen</h2>
          <div class="grid gap-6">
