...
<template>
  <div class="p-2">
    ...
    <div class="mt-5">
      <h2 id="einleitung-ueberblick" class="pb-1 font-bold">Einleitung und Überblick</h2>
      <p>
        ...
        <br />
        <strong class="pb-1 font-bold">Kurz gesagt:</strong> Wir informieren Sie umfassend über Daten, die wir über Sie
        verarbeiten.
      </p>
      <p>
        ...
        <strong class="pb-1 font-bold">Begriffe leserfreundlich erklärt</strong>, Links zu weiterführenden Informationen
        geboten und <strong class="pb-1 font-bold">Grafiken</strong> zum Einsatz gebracht. Wir informieren damit in
        ...
        und vielleicht ist die eine oder andere Information dabei, die Sie noch nicht kannten.
        <br />
      ...
      <h2 id="anwendungsbereich" class="pb-1 font-bold">Anwendungsbereich</h2>
      <p>
      ...
      <ul class="pb-1 font-bold">
        <li class="pb-1 font-bold">alle Onlineauftritte (Websites, Onlineshops), die wir betreiben</li>
        <li class="pb-1 font-bold">Social Media Auftritte und E-Mail-Kommunikation</li>
        <li class="pb-1 font-bold">mobile Apps für Smartphones und andere Geräte</li>
      </ul>
      <p>
        <strong class="pb-1 font-bold">Kurz gesagt:</strong> Die Datenschutzerklärung gilt für alle Bereiche, in denen
      ...
      <h2 id="rechtsgrundlagen" class="pb-1 font-bold">Rechtsgrundlagen</h2>
      <p>
      ...
      <ol>
        <li class="pb-1 font-bold">
          <strong class="pb-1 font-bold">Einwilligung</strong> (Artikel 6 Absatz 1 lit. a DSGVO): Sie haben uns Ihre
        ...
        <li class="pb-1 font-bold">
          <strong class="pb-1 font-bold">Vertrag</strong> (Artikel 6 Absatz 1 lit. b DSGVO): Um einen Vertrag oder
        ...
        <li class="pb-1 font-bold">
          <strong class="pb-1 font-bold">Rechtliche Verpflichtung</strong> (Artikel 6 Absatz 1 lit. c DSGVO): Wenn wir
        ...
        <li class="pb-1 font-bold">
          <strong class="pb-1 font-bold">Berechtigte Interessen</strong> (Artikel 6 Absatz 1 lit. f DSGVO): Im Falle
      ...
      <ul class="pb-1 font-bold">
        <li class="pb-1 font-bold">
          In <strong class="pb-1 font-bold">Österreich</strong> ist dies das Bundesgesetz zum Schutz natürlicher
          Personen bei der Verarbeitung personenbezogener Daten (
          <strong class="pb-1 font-bold">Datenschutzgesetz</strong>), kurz{' '}
          <strong class="pb-1 font-bold">DSG</strong>.
        </li>
        <li class="pb-1 font-bold">
          In <strong class="pb-1 font-bold">Deutschland</strong> gilt das{' '}
          <strong class="pb-1 font-bold">Bundesdatenschutzgesetz</strong>, kurz
          <strong class="pb-1 font-bold"> BDSG</strong>.
        </li>
      </ul>
      <p>
      ...
      <h2 id="kontaktdaten-verantwortliche" class="pb-1 font-bold">Kontaktdaten des Verantwortlichen</h2>
      <p>
        Sollten Sie Fragen zum Datenschutz oder zur Verarbeitung personenbezogener Daten haben, finden Sie nachfolgend
        die Kontaktdaten der verantwortlichen Person bzw. Stelle:
        <br />
      ...
      <p>
        E-Mail: <a href="mailto:datenschutz@sopaetzel.de">datenschutz@sopaetzel.de</a>
        <br />
        Impressum: <a href="https://sopaetzel.de/#/imprint">https://sopaetzel.de/#/imprint</a>
      </p>
      <h2 id="speicherdauer" class="pb-1 font-bold">Speicherdauer</h2>
      <p>
      ...
      <h2 id="rechte-dsgvo" class="pb-1 font-bold">Rechte laut Datenschutz-Grundverordnung</h2>
      <p>
      ...
      <ul class="pb-1 font-bold">
        <li class="pb-1 font-bold">
          ...
          erfahren:
          <ul class="pb-1 font-bold">
            <li class="pb-1 font-bold">zu welchem Zweck wir die Verarbeitung durchführen;</li>
            <li class="pb-1 font-bold">die Kategorien, also die Arten von Daten, die verarbeitet werden;</li>
            <li class="pb-1 font-bold">
              wer diese Daten erhält und wenn die Daten an Drittländer übermittelt werden, wie die Sicherheit garantiert
              werden kann;
            </li>
            <li class="pb-1 font-bold">wie lange die Daten gespeichert werden;</li>
            <li class="pb-1 font-bold">
            ...
            <li class="pb-1 font-bold">die Herkunft der Daten, wenn wir sie nicht bei Ihnen erhoben haben;</li>
            <li class="pb-1 font-bold">
        ...
        <li class="pb-1 font-bold">
          Sie haben laut Artikel 20 DSGVO das Recht auf Datenübertragbarkeit, was bedeutet, dass wir Ihnen auf Anfrage
      ...
      <p>
        <strong class="pb-1 font-bold">Kurz gesagt:</strong> Sie haben Rechte &#8211; zögern Sie nicht, die oben
      ...
      <h3 class="pb-1 font-bold">E-Mail</h3>
      <p>
      ...
      <h3 class="pb-1 font-bold">Online Formulare</h3>
      <p>
      ...
      <h3 class="pb-1 font-bold">Rechtsgrundlagen</h3>
      ...
      <p>
        <strong class="pb-1 font-bold">Name:</strong> _ga
        <br />
        <strong class="pb-1 font-bold">Wert:</strong> GA1.2.1326744211.152312475526-9
        <br />
        <strong class="pb-1 font-bold">Verwendungszweck:</strong> Unterscheidung der Websitebesucher
        <br />
        <strong class="pb-1 font-bold">Ablaufdatum:</strong> nach 2 Jahren
      </p>
      <p>Diese Mindestgrößen sollte ein Browser unterstützen können:</p>
      <ul class="pb-1 font-bold">
        <li class="pb-1 font-bold">Mindestens 4096 Bytes pro Cookie</li>
        <li class="pb-1 font-bold">Mindestens 50 Cookies pro Domain</li>
        <li class="pb-1 font-bold">Mindestens 3000 Cookies insgesamt</li>
      </ul>
      <h3 class="pb-1 font-bold">Welche Arten von Cookies gibt es?</h3>
      <p>
      ...
      <p>
        ...
        <a class="pb-1 font-bold" href="https://datatracker.ietf.org/doc/html/rfc6265">
          https://datatracker.ietf.org/doc/html/rfc6265
        </a>
        , dem Request for Comments der Internet Engineering Task Force (IETF) namens &#8220;HTTP State Management
        Mechanism&#8221;.
      </p>
      <h3 class="pb-1 font-bold">Zweck der Verarbeitung über Cookies</h3>
      <p>
      ...
      <h3 class="pb-1 font-bold">Welche Daten werden verarbeitet?</h3>
      <p>
      ...
      <h3 class="pb-1 font-bold">Speicherdauer von Cookies</h3>
      <p>
      ...
      <h3 class="pb-1 font-bold">Widerspruchsrecht &#8211; wie kann ich Cookies löschen?</h3>
      <p>
      ...
      <h3 class="pb-1 font-bold">Rechtsgrundlage</h3>
      <p>
        Seit 2009 gibt es die sogenannten „Cookie-Richtlinien“. Darin ist festgehalten, dass das Speichern von Cookies
        eine <strong class="pb-1 font-bold">Einwilligung</strong> (Artikel 6 Abs. 1 lit. a DSGVO) von Ihnen verlangt.
        ...
        Deutschland wurden die Cookie-Richtlinien nicht als nationales Recht umgesetzt. Stattdessen erfolgte die
      ...
      <p>
        ...
        <strong class="pb-1 font-bold">berechtigte Interessen</strong> (Artikel 6 Abs. 1 lit. f DSGVO), die in den
      ...
      <p>
        ...
        Zusammenarbeit verarbeitet werden, um die angebotenen Leistungen erbringen zu können. Kundendaten sind also alle
        gesammelten Informationen, die wir über unsere Kunden erheben und verarbeiten.
      </p>
      <h3 class="pb-1 font-bold">Warum verarbeiten wir Kundendaten?</h3>
      <p>
        Es gibt viele Gründe, warum wir Kundendaten sammeln und verarbeiten. Der wichtigste ist, dass wir zur
        Bereitstellung unserer Services einfach verschiedene Daten benötigen. Manchmal reicht hier schon Ihre
        E-Mail-Adresse, doch wenn Sie etwa ein Produkt oder eine Dienstleistung erwerben, benötigen wir auch Daten wie
        beispielsweise Name, Adresse, Bankdaten oder Vertragsdaten. Wir nutzen die Daten in weiterer Folge auch für
        Marketing- und Vertriebsoptimierungen, damit wir insgesamt unser Service für unsere Kunden verbessern können.
        Ein weiterer wichtiger Punkt ist auch unser Kundenservice, der uns stets sehr am Herzen liegt. Wir wollen, dass
        Sie mit Frage zu unseren Angeboten jederzeit zu uns kommen können und dafür brauchen wir zumindest Ihre
        E-Mail-Adresse.
      </p>
      <h3 class="pb-1 font-bold">Welche Daten werden verarbeitet?</h3>
      <p>
        Welche Daten genau gespeichert werden, kann an dieser Stelle nur anhand Kategorien wiedergegeben werden. Dies
        hängt nämlich stets davon ab, welche Leistungen Sie von uns beziehen. In manchen Fällen geben Sie uns lediglich
        ...
        benötigen wir deutlich mehr Informationen, wie etwa Ihre Kontaktdaten, Zahlungsdaten und Vertragsdaten.
      </p>
      <p>Hier eine Liste möglicher Daten, die wir von Ihnen erhalten und verarbeiten:</p>
      <ul class="pb-1 font-bold">
        <li class="pb-1 font-bold">Name</li>
        <li class="pb-1 font-bold">Kontaktadresse</li>
        <li class="pb-1 font-bold">E-Mail-Adresse</li>
        <li class="pb-1 font-bold">Telefonnummer</li>
        <li class="pb-1 font-bold">Geburtsdatum</li>
        <li class="pb-1 font-bold">Zahlungsdaten (Rechnungen, Bankdaten, Zahlungshistorie etc.)</li>
        <li class="pb-1 font-bold">Vertragsdaten ( Laufzeit, Inhalt)</li>
        <li class="pb-1 font-bold">Nutzungsdaten (besuchte Websites, Zugriffsdaten ect.)</li>
        <li class="pb-1 font-bold">Metadaten (IP-Adresse, Geräte-Informationen)</li>
      </ul>
      <h3 class="pb-1 font-bold">Wie lange werden die Daten gespeichert?</h3>
      <p>
        Sobald wir die Kundendaten zur Erfüllung unserer vertraglichen Pflichten und unserer Zwecke nicht mehr benötigen
        und die Daten auch nicht für mögliche Gewährleistungs- und Haftungspflichten nötig sind, löschen wir die
        entsprechenden Kundendaten. Das ist zum Beispiel der Fall, wenn ein geschäftlicher Vertrag endet. Danach beträgt
        die Verjährungsfrist in der Regel 3 Jahre, wobei längere Fristen im Einzelfall möglich sind. Wir halten uns
        natürlich auch an die gesetzlichen Aufbewahrungspflichten. Ihre Kundendaten werden ganz sicher nicht an Dritte
        weitergegeben, wenn Sie dazu nicht explizit eine Einwilligung erteilt haben.
      </p>
      <h3 class="pb-1 font-bold">Rechtsgrundlage</h3>
      <p>
        Rechtsgrundlagen für die Verarbeitung Ihrer Daten sind Art. 6 Abs. 1 lit. a DSGVO (Einwilligung), Art. 6 Abs 1
        lit. b DSGVO (Vertrag bzw. vorvertragliche Maßnahmen), Art. 6 Abs. 1 lit. f DSGVO (berechtigte Interessen) und
        in speziellen Fällen (z. B. bei medizinischen Leistungen) Art. 9 Abs. 2 lit. a. DSGVO (Verarbeitung besonderer
        Kategorien).
      </p>
      <p>
        Für den Fall des Schutzes lebenswichtiger Interessen erfolgt die Datenverarbeitung gemäß Art. 9 Abs. 2 lit. c.
        ...
        im Gesundheits- oder Sozialbereich erfolgt die Verarbeitung personenbezogener Daten gemäß Art. 9 Abs. 2 lit. h.
        DSGVO. Wenn Sie freiwillig Daten der besonderen Kategorien mitteilen, erfolgt die Verarbeitung auf Grundlage von
      ...
      <p>
        ...
        während der Datenübertragung zu und vom Webserver kann es zu einer Verarbeitung personenbezogener Daten kommen.
        Einerseits speichert Ihr Computer Daten, andererseits muss auch der Webserver Daten eine Zeit lang speichern, um
        einen ordentlichen Betrieb zu gewährleisten.
      </p>
      <p>
      ...
      <p></p>
      <h3 class="pb-1 font-bold">Warum verarbeiten wir personenbezogene Daten?</h3>
      <p>Die Zwecke der Datenverarbeitung sind:</p>
      <ol>
        <li class="pb-1 font-bold">Professionelles Hosting der Website und Absicherung des Betriebs</li>
        <li class="pb-1 font-bold">zur Aufrechterhaltung der Betriebs- und IT-Sicherheit</li>
        <li class="pb-1 font-bold">
      ...
      <ul class="pb-1 font-bold">
        <li class="pb-1 font-bold">die komplette Internetadresse (URL) der aufgerufenen Webseite</li>
        <li class="pb-1 font-bold">Browser und Browserversion (z. B. Chrome 87)</li>
        ...
        <li class="pb-1 font-bold">Datum und Uhrzeit</li>
        <li class="pb-1 font-bold">in Dateien, den sogenannten Webserver-Logfiles</li>
      </ul>
      <h3 class="pb-1 font-bold">Wie lange werden Daten gespeichert?</h3>
      <p>
      ...
      <p>
        <strong class="pb-1 font-bold">Kurz gesagt:</strong> Ihr Besuch wird durch unseren Provider (Firma, die unsere
      ...
      <p>
        Zwischen uns und dem Hosting-Provider besteht in der Regel ein Vertrag über die Auftragsverarbeitung gemäß Art.
        28 f. DSGVO, der die Einhaltung von Datenschutz gewährleistet und Datensicherheit garantiert.
      </p>
      <h2 id="firebase-cloud-datenschutzerklaerung" class="pb-1 font-bold">Firebase Cloud Datenschutzerklärung</h2>
      <p>
        Wir verwenden auf unserer Website Firebase, unter anderem ein Webhosting- und Cloud-Dienst. Dienstanbieter ist
      ...
      <p>
        ...
        <a class="pb-1 font-bold" href="https://eur-lex.europa.eu/eli/dec_impl/2021/914/oj?locale=de">
      ...
      <p>
        ...
        Analytics oder Web-Analyse genannt. Dabei werden Daten gesammelt, die der jeweilige Analytic-Tool-Anbieter (auch
        ...
        können auch Userprofile erstellt werden und die Daten in Cookies gespeichert werden.
      </p>
      <h3 class="pb-1 font-bold">Warum betreiben wir Web Analytics?</h3>
      <p>
        Mit unserer Website haben wir ein klares Ziel vor Augen: wir wollen für unsere Branche das beste Webangebot auf
      ...
      <h3 class="pb-1 font-bold">Welche Daten werden verarbeitet?</h3>
      <p>
        Welche Daten genau gespeichert werden, hängt natürlich von den verwendeten Analyse-Tools ab. Doch in der Regel
      ...
      <p></p>
      <p>
        Wie lange die jeweiligen Daten gespeichert werden, hängt immer vom Anbieter ab. Manche Cookies speichern Daten
      ...
      <p>
        ...
        gesetzlich vorgeschrieben ist, kann diese Speicherdauer auch überschritten werden.
      </p>
      <h3 class="pb-1 font-bold">Widerspruchsrecht</h3>
      <p>
      ...
      <h3 class="pb-1 font-bold">Rechtsgrundlage</h3>
      <p>
        Der Einsatz von Web-Analytics setzt Ihre Einwilligung voraus, welche wir mit unserem Cookie Popup eingeholt
        haben. Diese Einwilligung stellt laut
        <strong class="pb-1 font-bold"> Art. 6 Abs. 1 lit. a DSGVO (Einwilligung)</strong> die Rechtsgrundlage für die
        Verarbeitung personenbezogener Daten, wie sie bei der Erfassung durch Web-Analytics Tools vorkommen kann, dar.
      </p>
      <p>
        ...
        <strong class="pb-1 font-bold">Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</strong>. Wir setzen die
      ...
      <h2 id="firebase-datenschutzerklaerung" class="pb-1 font-bold">Firebase Datenschutzerklärung</h2>
      <p>
        Wir verwenden auf unserer Website Firebase, ein Analyse- und Monitoring-Tool. Dienstanbieter ist das
